  ...
  communicationstatus() {
    ...
    axios
      .post("http://localhost:5000/initialize.php", {
        ...
        initialFinecv: this.props.app.cvStageValue.FourInchControlIntValue,
        initialComprAircv_B2:
          this.props.app.cvStageValue.ComprAirInitialValue_B2,
        initialMainGascv_B2: this.props.app.cvStageValue.MainGasInitialValue_B2,
      })
      .then((res) => {
  ...
  startClick = () => {
    if (this.props.app.communication === true) {
      if (this.props.app.targetRPM !== "" && this.props.app.targetTemp !== "") {
        ...
        this.props.changeStartState(true);
                  ...
                  <Row gutter={[16, 8]} style={{ paddingLeft: "20px" }}>
                    ...
                    >
                      {communication ? (
                        ...
                        >
                          <Radio value={1} className="radio-btn">
                            {this.props.app.turboChargerType == 1 ? (
                              <span className="disable-btn-active">
                                {" "}
                                Burner 1
                              </span>
                            ) : (
                          ...
                          <Radio value={2} className="radio-btn">
                            {this.props.app.turboChargerType == 2 ? (
                              <span className="disable-btn-active">
                                {" "}
                                Burner 2
                              </span>
                        ...
                        <Radio.Group
                          name="radiogroup"
                          defaultValue={this.state.turboState}
            ...
            <Col span={5}>
              <Card
                style={
                  ...
                  communication
                    ? { width: 180, cursor: "pointer", borderColor: "green" }
                    : { width: 180, borderColor: "gray" }
                }
              >
                <div style={{ width: "300px" }}>
                  {StartdataArray.find((it) => it.name === "Stage 3") &&
